...
INSTALLED_APPS = [
    ...
    "enterprise_hrms.accounts",
    "enterprise_hrms.employees",
    "enterprise_hrms.departments",
    "enterprise_hrms.attendance",
    "enterprise_hrms.payroll",
    "enterprise_hrms.leave_management",
    "enterprise_hrms.documents",
    "enterprise_hrms.reports",
    "enterprise_hrms.audit_logs",
