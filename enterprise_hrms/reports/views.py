...
class EmployeeReportView(APIView):
    ...
    def get(self, request):
        ...
        headers = [
            ...
            'DOB', 'Gender', 'Department', 'Designation', 'Salary', 
            'Joining Date', 'Status'
        ]
...
class DepartmentReportView(APIView):
    ...
    def get(self, request):
        ...
        headers = ['Department Name', 'Code', 'Manager', 'Description', 'Employee Count']
        
        rows = []
        for dept in queryset:
            manager_name = f"{dept.manager.first_name} {dept.manager.last_name}" if dept.manager else 'N/A'
            rows.append([
                dept.name,
                dept.code,
                manager_name,
...
class AttendanceReportView(APIView):
    ...
    def get(self, request):
        ...
        for att in queryset:
            ...
            check_out_str = att.check_out.strftime('%H:%M:%S') if att.check_out else 'N/A'
            rows.append([
